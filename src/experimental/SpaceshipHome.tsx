...
import { DivinationIcon, WaruikoIcon, RecordIcon, BackIcon, TempleIcon } from '../components/Icons';

const { width, height } = Dimensions.get('window');

interface SpaceshipHomeProps {
  navigation: any;
}

const SpaceshipHome: React.FC<SpaceshipHomeProps> = ({ navigation }) => {
  // 惑星の軌道アニメーション
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>神聖なる聖域</Text>
